...
const DEMO_DATA = {
  ...
  datasets: [
    ...
    {
      id: 'demo-ds-7',
      title: 'London Artisan Bakery Sales & Footfall 2023–2024',
      description: 'High-density European urban retail transactions, daily footfall, and morning peak patterns across 2 London locations (Soho & Camden).',
      category: 'Retail Sales',
      ...
      date_range_end: '2024-12-31',
      auction_end: new Date(Date.now() + 4.5 * 86400 * 1000).toISOString(),
      status: 'active',
      tags: ['retail', 'london', 'bakery', 'uk'],
      profiles: { business_name: 'Bloomsbury Bakehouse', industry: 'Food & Beverage', verified: true },
    },
    {
      id: 'demo-ds-8',
      title: 'Toronto Tech Hardware Wholesale Inventory 2024',
      description: 'Canadian cross-border tech components stock turnover, supplier lead times, and SKU unit margins across Ontario distributor warehouses.',
      category: 'Inventory',
      ...
      row_count: 12100,
      date_range_start: '2024-01-01',
      date_range_end: '2024-12-15',
      auction_end: new Date(Date.now() + 2.8 * 86400 * 1000).toISOString(),
      status: 'active',
      tags: ['canada', 'inventory', 'technology', 'wholesale'],
      profiles: { business_name: 'MapleCore Logistics', industry: 'Logistics', verified: true },
    },
    {
      id: 'demo-ds-9',
      title: 'Berlin Specialty Coffee & Co-Working Habits 2024',
      description: 'Hourly customer durations, euro-denominated average basket sizes, and digital nomad peak hours in Mitte and Kreuzberg cafes.',
      category: 'Customer Demographics',
      ...
      auction_end: new Date(Date.now() + 6.2 * 86400 * 1000).toISOString(),
      status: 'active',
      tags: ['berlin', 'germany', 'cafe', 'europe'],
      profiles: { business_name: 'KaffeeWerk Berlin', industry: 'Hospitality', verified: true },
    },
  ],
